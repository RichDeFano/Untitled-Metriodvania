...
if (global.statusBurning == true)
{
	...
	{
	obj_PlayerStatusAlarms.alarm[0] = 5;
...
if (global.statusPoison == true)
{
	...
	{
	obj_PlayerStatusAlarms.alarm[1] = 5;
...
if (global.statusDazed == true)
{
	...
	scr_buttonMovement();
	obj_PlayerStatusAlarms.alarm[2] = 5;
...
if (global.statusCursed == true)
{
	...
	{
	obj_PlayerStatusAlarms.alarm[3] = 5;
...
if (global.statusFrozen == true)
{
	...
	{
	obj_PlayerStatusAlarms.alarm[4] = 5;
...
{
	if (global.haveSet6 == false)
	{
	obj_PlayerStatusAlarms.alarm[7] = 5;
	global.haveSet6 = true;
	}
}
