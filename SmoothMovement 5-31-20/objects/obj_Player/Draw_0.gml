...
scr_whichHookshot();
//scr_draw_hookshot();
//var nearestSlope = instance_nearest(obj_slope);
...
{ 
	///Need to update angle on slope WITHOUT breaking collision
		image_angle = 0;
	/*
	{image_angle = 0;}
	else
	{image_angle = 270-degrees;}
	*/
...
else
{
	...
	draw_sprite_ext(spr_player_swing,image_index,x,y,image_xscale,image_yscale,image_angle,image_blend,image_alpha);
	pal_swap_reset();
}
