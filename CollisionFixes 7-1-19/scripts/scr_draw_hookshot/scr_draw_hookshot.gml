...
{
	if ( ((ropeAngle-90) > -90) && ((ropeAngle-90) < 90))
	{
		if ((sprite_index == spr_player_stand) || (sprite_index == spr_player_run))
		{
			draw_sprite_ext(spr_canHookWall,1,r[1],r[2],1,1,ropeAngle-90,c_red,image_alpha);
			draw_sprite_ext(spr_hookshotView,0,x+5,y+10,1,1,ropeAngle+90,image_blend,0.10);
			failedShot = true;
		}
	}
