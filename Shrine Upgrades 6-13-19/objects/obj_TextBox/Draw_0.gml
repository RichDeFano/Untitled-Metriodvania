...
var xcreate, ycreate, xcreate2, ycreate2,sizeOfText,str1,str2;
...
/*
str1 = string_char_at(text[0],charCount);
str2 = string_char_at(text[0],charCount+1);
if ((str1 == "/") && (str2 == "*"))
	{draw_set_font(global.FontRed);}
if ((str1 == "*") && (str2 == "/"))
	{draw_set_font(global.Font);}
	*/
	draw_set_font(global.Font);
