...
if ((contract == false) && (connected == false))
{
	...
	{
	    draw_sprite_ext(spr_hookChain, 0, obj_Player.x + xx * i, obj_Player.y + yy * i, 1, 1, ropeAngle+90, image_blend, 1);
		draw_sprite_ext(spr_hookEnd, 0, obj_Player.x + xx * count, obj_Player.y + yy * count, 1, 1, ropeAngle+90, image_blend, 1);
	}
}
