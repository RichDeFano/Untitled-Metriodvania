...
{
	failedShot = true;
	draw_sprite_ext(spr_canDHookWall,1,destX,destY,1,1,ropeAngle-90,c_red,image_alpha);
...
else
{
	...
	if (instance_exists(obj_movingPlatform))
	{
		...
		{
		hookOnMoving = true;
		draw_sprite_ext(spr_canDHookWall,0,r[1],r[2],1,1,ropeAngle-90,c_black,image_alpha);
		draw_sprite_ext(spr_hookshotView,0,x+5,y+10,1,1,ropeAngle+90,image_blend,0.50);	
		}
		else
		{
		hookOnMoving = false;
		draw_sprite_ext(spr_canDHookWall,0,r[1],r[2],1,1,ropeAngle-90,c_green,image_alpha);
		draw_sprite_ext(spr_hookshotView,0,x+5,y+10,1,1,ropeAngle+90,image_blend,0.50);
		}
	}
	else
...
else
{
	...
	instance_create_layer(r[1],r[2],"ObjOverPlayer",obj_darkHSMask);
}
}
}
}
