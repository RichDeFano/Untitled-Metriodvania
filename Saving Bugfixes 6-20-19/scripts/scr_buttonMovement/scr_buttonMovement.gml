...
key_rtr = (keyboard_check_released(global.P1key_rtr) || (keyboard_check_released(global.P1key_rsh)));
key_ltr = (keyboard_check_released(global.P1key_ltr) || (keyboard_check_released(global.P1key_lsh)));
