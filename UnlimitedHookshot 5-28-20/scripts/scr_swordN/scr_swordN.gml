...
if ((dashing == false) && (global.inText == false) && (global.atShrine == false) && (global.canInteract == false) && (global.statusCursed == false) && (global.canInteractShrine == false) && (global.canInteractTeleport == false))
{
