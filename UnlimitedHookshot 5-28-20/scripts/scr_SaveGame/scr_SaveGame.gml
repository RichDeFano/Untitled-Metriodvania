...
ds_map_add(_map,"44",global.hookshotUnlocked);
...
ds_map_add(_map,"81",global.zone);

//Gemstone Cavern Keys
ds_map_add(_map,"76",global.moonDungeon1BossKey);
ds_map_add(_map,"77",global.moonDungeon1BossDoor);

var keyDataGS = scr_saveKeys(global.moonDungeon1Keys);
var doorDataGS = scr_saveDoors(global.moonDungeon1Doors);
ds_map_add(_map,"78",ds_list_write(keyDataGS));
ds_map_add(_map,"79",ds_list_write(doorDataGS));
...
ds_map_add(_map,"82",global.bossDefeated6);
ds_map_add(_map,"83",global.bossDefeated7);
ds_map_add(_map,"84",global.bossDefeated8);
ds_map_add(_map,"85",global.bossDefeated9);
ds_map_add(_map,"86",global.bossDefeated10);

ds_map_add(_map,"87",global.minibossDefeated1);
ds_map_add(_map,"88",global.minibossDefeated2);
ds_map_add(_map,"89",global.minibossDefeated3);
ds_map_add(_map,"90",global.minibossDefeated4);
ds_map_add(_map,"91",global.minibossDefeated5);
ds_map_add(_map,"92",global.minibossDefeated6);
ds_map_add(_map,"93",global.minibossDefeated7);
ds_map_add(_map,"94",global.minibossDefeated8);
ds_map_add(_map,"95",global.minibossDefeated9);
ds_map_add(_map,"96",global.minibossDefeated10);
ds_map_add(_map,"97",global.hookshotUnlocked);
